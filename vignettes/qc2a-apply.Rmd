---
title: "Controle de qualidade 2a - Teste de Persistência Temporal"
...
```{r}
# Definições iniciais
id_qc <- '2a' # identificador do teste de controle de qualidade aplicado
...
filter(var_data_qc, tavg_qc2 == 1) %>% arrange(site)
```
...
## var_nr_susp <- var_data_qc %>% filter(tavg_qc2 == 1) %>% nrow()
