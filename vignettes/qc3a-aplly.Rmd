...
```{r}
# Definições iniciais
id_qc <- '3a' # identificador do teste de controle de qualidade aplicado
...
filter(var_data_qc, tmin_qc3a == 1) %>% arrange(site)
```
...
## var_nr_susp <- var_data_qc %>% filter(tmin_qc3a == 1) %>% nrow()
